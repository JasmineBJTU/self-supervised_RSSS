...
class DRN(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000,
        ...
        self.deconv4 = nn.ConvTranspose2d(128, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn_d4 = nn.BatchNorm2d(64)
        self.deconv5 = nn.ConvTranspose2d(64, 32, kernel_size=3, stride=1, padding=1, bias=False)
